...
function App() {
  return (<>
    <section className='bg-zinc-100 my-4 rounded-lg max-w-sm mx-auto shadow-xl border cursor-pointer transition hover:bg-zinc-200 hover:scale-105 active:scale-95 md:max-w-md'>
